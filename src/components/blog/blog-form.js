...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "", 
            apiUrl: "https://viteok.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        }
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({
                ...
                apiUrl: `https://viteok.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
                apiAction: "patch"
            })

            console.log("blog status : " + this.props.blog.blog_status);
        }
    }
